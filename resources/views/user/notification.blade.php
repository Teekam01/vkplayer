...
<div class="main-area" style="padding-top: 60px;">
	...
	<div class="cxy flex-column px-4 text-center" style="margin-top: 70px;"><img src="{{asset('frontend/images/nonotification.png')}}" width="280px" alt="">
		<div class="games-section-title mt-4" style="font-size: 1.2em;">No Notifications yet!</div>
	...
	@foreach($notifications as $row)
	    <div class="w-100 py-3 d-flex align-items-center list-item">
			<div class="center-xy list-date mx-2">
    			    @if($row->title == 'Withdraw Rejected.')
    				<img width="32px" src="{{asset('frontend/images/rejected.png')}}" alt="" style="border-radius: 5px;">
    				@endif
    				@if($row->title == 'Cash Added By Admin')
    				<img width="32px" src="{{asset('frontend/images/salary.png')}}" alt="" style="border-radius: 5px;">
    				@endif
    				@if($row->title == 'KYC Rejected.')
    				<img width="32px" src="{{asset('/frontend/images/rejected.png')}}" style="border-radius: 5px;" alt="">
    				@endif
    				@if($row->title == 'Penalty')
    				<img width="32px" src="{{asset('/frontend/images/penalty.png')}}" style="border-radius: 5px;" alt="">
    				@endif
    				@if($row->title == 'KYC Verified Successfully')
    				<img width="32px" src="{{asset('/frontend/images/verified.png')}}" style="border-radius: 5px;" alt="">
    				@endif
			</div>
			...
			<div class="mx-3 d-flex list-body">
			    ...
			    <div class="d-flex flex-column font-8"
                            style="font-family: Saira Semi Condensed,sans-serif; font-weight:700 ">
                            {{ $row->title }}
                            @if ($row->text)
                                <div class="games-section-headline" style="font-family: Dosis,sans-serif; Color:red">Note:
                                    {{ $row->text }}</div>
                                {{-- <div class="games-section-headline" style="font-family: Dosis,sans-serif; Color:red">Reason: {{ $user_data->remark }}</div> --}}
                            @endif
			</div>
