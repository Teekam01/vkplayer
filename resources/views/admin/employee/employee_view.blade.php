...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800"><a href="{{ url()->previous() }}" class="btn btn-secondary"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Back</a> View Employee Details</h1>
	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Employee VIEW</h6>
		</div>
		<div class="card-body">
			<table class="table table-stripped">
				...
				<tr>
					...
					<td>
						<ol>
						     @if($allowed_menus->players == '1')<li>Players</li>@endif
							 @if($allowed_menus->all_players == 1)<li>All Players</li>@endif
							 @if($allowed_menus->block_players == 1)<li>Block Players</li>@endif
							 @if($allowed_menus->battle == 1)<li>Battle</li>@endif
							 @if($allowed_menus->new_battle == 1)<li>New Battle</li>@endif
							 @if($allowed_menus->battle_running == 1)<li>Battle Running</li>@endif
							 @if($allowed_menus->battle_result == 1)<li>Battle_result</li>@endif
							 @if($allowed_menus->kyc == 1)<li>KYC</li>@endif
							 @if($allowed_menus->pending_kyc == 1)<li>Pending KYC</li>@endif
							 @if($allowed_menus->approved_kyc == 1)<li>Approved KYC</li>@endif
							 @if($allowed_menus->payments == 1)<li>Payments</li>@endif
							 @if($allowed_menus->payment_received == 1)<li>Payment Received</li>@endif
							 @if($allowed_menus->recharge_to_user == 1)<li>Recharge to User</li>@endif
							 @if($allowed_menus->payment_settings == 1)<li>Payment Settings</li>@endif
							 @if($allowed_menus->withdraw_request == 1)<li>Withdraw Request</li>@endif
							 @if($allowed_menus->admin_settings == 1)<li>Admin Settings</li>@endif
							 @if($allowed_menus->support == 1)<li>Support</li>@endif
							 @if($allowed_menus->games == 1)<li>Games</li>@endif
							 @if($allowed_menus->marquee_notification == 1)<li>Marquee Notification</li>@endif
							 @if($allowed_menus->employees_management == 1)<li>Employees Management</li>@endif
							 @if($allowed_menus->employees == 1)<li>Employees</li>@endif
							 @if($allowed_menus->permission == 1)<li>Permission</li>@endif
						</ol>
