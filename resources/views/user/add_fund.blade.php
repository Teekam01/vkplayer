	...
	<div class="px-4 py-3">
		<div class="games-section">
			...
			<div class="alert alert-danger" role="alert">
			  Note: सफलतापूर्वक भुगतान हो जाने के बाद नीचे दी गई इमेज आने का इंतजार करें |

			</div>
			<center><img src="{{asset('frontend/images/Got_It-removebg-preview.jpg')}}" width="150" height="100"></center>
		</div>
			@if($activated_gateway->name == 'UPI API')
			  <form action="{{ url('upiapi/create') }}" method="post">
			@endif
				...
				<div class="games-window">
					...
					<div class="gameCard-container" id="amount2">
						<div class="add-fund-box">
							<div style="display: flex; align-items: baseline;">
								<div class="collapseCard-title mr-1" style="font-size: 0.9em;">₹</div>
								<div class="collapseCard-title" style="font-size: 1.5em;">250</div>
							</div>
						</div>
					</div>
			...
			<div class="refer-footer">
				...
				<button type="submit" class="disabledButton btn btn-primary btn-lg" style="width:100%" >NEXT</button>
			</div>
		</form>
	</div>
</div>
...
*/
	...
	function changeAmount2() {
		document.getElementById('Textfield').value = '250';
		var textBox = $('#Textfield').val() * 1;
		if ((textBox >= 10) && (textBox <= 20000)) {
			$('.disabledButton').prop("disabled", false);
		} else {
